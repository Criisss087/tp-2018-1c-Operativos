...
#define ARCH_CONFIG_PUERTO_COORD "PUERTO_COORDINADOR"
#define ARCH_CONFIG_PUERTO_PLANIF "PUERTO_PLANIFICADOR"
#define ARCH_CONFIG_IP_COORD "IP_COORDINADOR"
#define ARCH_CONFIG_IP_PLANIF "IP_PLANIFICADOR"
